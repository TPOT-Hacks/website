    ...
    <main className="space-y-8">
      ...
      <section className="space-y-4">
        <p className="text-gray-300 text-lg">
          Welcome to TPOT Hacks, a weekly gathering where developers come
          together to explore, hack, and learn. Every week, we tackle a new
          programming challenge or mini-project.
        </p>

        <p className="text-gray-300">Our format is simple:</p>
        ...
        <p className="text-gray-300 mt-4">
          You can find all our previous hacks with links and short descriptions{" "}
          <Link
            href="/hacks"
          ...
          , and a blog post that goes with each hack{" "}
          <Link
            href="/blog"
            className="text-white underline underline-offset-4"
          >
